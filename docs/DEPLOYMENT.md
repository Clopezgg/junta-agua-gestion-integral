...
3. Aplicar todas las migraciones en orden ascendente (`001` a `032`), preferentemente con `supabase db push` o el plan de migraciones sincronizado.
...
11. Validar la base local con el flujo de CI de `db-validate.yml` (migraciones 001–032 + invariantes de integridad).
