...
export const rolePermissions:Record<string,Permission[]>={
 ...
 secretary:['subscribers.read','subscribers.create','subscribers.update','tariffs.read','obligations.read','payments.read','payments.create','cash.manage','expenses.read','expenses.create','reports.read','communications.send','ocr.use','map.read','budget.read','assets.read','metering.read','imports.read','imports.manage'],
 treasurer:['subscribers.read','tariffs.read','obligations.read','payments.read','payments.create','cash.manage','expenses.read','expenses.create','expenses.approve','expenses.confirm','finance.read','bank.manage','reports.read','reports.export','communications.send','map.read','budget.read','budget.manage','assets.read','metering.read','metering.manage','imports.read'],
 auditor:['subscribers.read','tariffs.read','obligations.read','payments.read','expenses.read','finance.read','reports.read','reports.export','audit.read','backups.read','map.read','budget.read','assets.read','metering.read','imports.read','integrations.read','updates.read'],
 member:['subscribers.read','tariffs.read','obligations.read','reports.read','map.read','budget.read','assets.read','metering.read'],
 technician:['subscribers.read','obligations.read','operations.read','operations.manage','inventory.read','inventory.manage','map.read','assets.read','assets.manage','maintenance.manage','metering.read','metering.manage','imports.read','imports.manage']
};
