...
export const rolePermissions:Record<string,Permission[]>={
 ...
 auditor:['subscribers.read','tariffs.read','obligations.read','payments.read','expenses.read','finance.read','reports.read','reports.export','audit.read','backups.read','map.read','budget.read','assets.read','metering.read','imports.read','integrations.read','updates.read','document_templates.read','benefits.read','service_catalog.read'],
