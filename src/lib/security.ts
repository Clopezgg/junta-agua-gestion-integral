...
export const rolePermissions:Record<string,Permission[]>={
 ...
 technician:['subscribers.read','obligations.read','operations.read','operations.manage','inventory.read','inventory.manage','map.read','assets.read','assets.manage','maintenance.manage','metering.read','metering.manage','imports.read','imports.manage','service_catalog.read','incidents.read','incidents.manage']
};
