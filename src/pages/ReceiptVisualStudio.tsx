...
export function ReceiptVisualStudio(){
  ...
  const[brand,setBrand]=useState<ReceiptBrand>({
    name:'Junta Patronal de Agua Potable El Achiotal',
    shortName:'JAPA El Achiotal',
    slogan:'Servicio comunitario, transparente y responsable',
    address:'Aldea El Achiotal, municipio de Santa Cruz de Yojoa, departamento de Cortés, Honduras',
    rtn:'PENDIENTE',
    ...
    footer:'Documento oficial emitido por la Junta Patronal de Agua Potable El Achiotal. Su autenticidad se verifica mediante el código QR.',
  ...
  const receipt=useMemo<ReceiptInput>(()=>({
    ...
    address:'Aldea El Achiotal, sector Centro',
    sector:'Centro',
