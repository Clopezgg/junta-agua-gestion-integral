 ...
 const topLabel=titleFor(location.pathname);
  const groups:Item[][]=[
   ...
   [
    ...
    {to:'/abonado-360',label:'Abonado 360',icon:<Compass size={18}/>,show:auth.has('subscribers.read')},
   ...
   [
    ...
    {to:'/mantenimiento',label:'Mantenimiento',icon:<Wrench size={18}/>,show:auth.has('maintenance.manage')},
     ...
     {to:'/lecturas-campo',label:'Lecturas de campo',icon:<Camera size={18}/>,show:auth.has('field.read')},
