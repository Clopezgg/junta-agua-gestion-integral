...
const actions:CreateAction[]=[
  ...
  {label:'Orden de trabajo',to:'/operaciones',permission:'operations.manage',icon:<Barcode size={16}/>},
  {label:'Gasto',to:'/gastos',permission:'expenses.create',icon:<ShoppingCart size={16}/>},
  {label:'Compra',to:'/compras',permission:'expenses.create',icon:<PackagePlus size={16}/>},
  {label:'Reunión',to:'/reuniones',permission:'governance.manage',icon:<Gavel size={16}/>},
  {label:'Muestra de calidad',to:'/calidad',permission:'water.manage',icon:<Sparkles size={16}/>},
  {label:'Proyecto',to:'/proyectos',permission:'governance.manage',icon:<HandCoins size={16}/>},
];
